...
from channel_wise_lstms_model import channel_wise_lstms
import lstm_utils
import utils
...
class cw_lstm():
    ...
    def __init__(self, batch_norm=False, batch_size=128, data='', depth=2, hid_dim=16, dropout=0.3, epochs=100,
                 imputation='previous', load_state='', learning_rate=0.05, input_dim=76,
    ...
    def train(self):
        ...
        if self.normalizer_state is None:
            self.normalizer_state = './resources/ihm_ts{}.input_str:{}.start_time:zero.normalizer'.format(self.timestep,
                                                                                                          self.imputation)
        ...
        # Build the model
        print("==> using model {}".format('channel_wise_lstm'))
        model = channel_wise_lstms(**args_dict)
        model_name = "{}.n{}.szc{}{}{}{}.dep{}.bs{}.ts{}".format('channel_wise_lstms',
                                                                     self.hid_dim,
                                                                     self.model_size,
    ...
    def test(self, load_state=''):
        ...
        args_dict = {'batch_norm': self.batch_norm, 'depth': self.depth, 'hid_dim': self.hid_dim,
                     ...
                     'num_classes': self.num_classes}
        # Build the model
        print("==> testing model {}".format('channel_wise_lstm'))
        model = channel_wise_lstms(**args_dict)
...
if __name__ == "__main__":
    cw_lstm = cw_lstm(batch_norm=False, batch_size=512, depth=2, hid_dim=16, dropout=0.3, epochs=100,
