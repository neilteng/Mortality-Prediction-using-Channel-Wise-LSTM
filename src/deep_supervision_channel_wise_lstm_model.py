...
from lstm_utils import ExtendMask, Slice,LastTimestep


class ds_channel_wise_lstms(Model):
    ...
    def __init__(self, hid_dim, batch_norm, dropout, recurrent_dropout, channels,
        ...
        super(ds_channel_wise_lstms, self).__init__(inputs=inputs, outputs=outputs)
